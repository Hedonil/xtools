...
my $xpoints = 600;
my $ypoints = 350;
my $rrd = '/data/project/newwebtest/lighttpd.rrd';   # path to where the RRD database is
my $tmp_dir = '/data/project/newwebtest/tmp'; # temporary directory where to store the images
